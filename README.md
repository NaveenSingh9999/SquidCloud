...
***Warning -** This Repository is an showcase repo not an actual codebase, please first read [NOTICE.md](https://github.com/NaveenSingh9999/SquidCloud/blob/main/NOTICE.md) immediately , highly recommended for viewers.*
